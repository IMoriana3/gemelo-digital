...
- **El eje de transmisión y los ajustes de sombra no se han inventado aquí**: las cotas (Ø 60 mm, 22 cm bajo el eje del tubo, cardanes) son las de `overcast.html`, y el criterio de sombras —recuadro ceñido a la vista y ANISÓTROPO con el sol rasante— el de `backtracking.html`, que ya dejó escrito por qué salía en sierra.

...
- **El diámetro del eje de transmisión (50 mm) es una estimación**, no una cota de proyecto como el resto de `seguidor.js`. Está marcado como tal en el modelo; cuando llegue la cota buena se cambia en un sitio y cambia en todas las páginas.

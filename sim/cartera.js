...
(function (raiz) {
  var CARTERA = {
   "_que_es": "Cartera de proyectos con coordenadas. GENERADO por tools/genera_plantas.mjs desde la exportación de factiun-cartera (datos/cartera_20260909.csv) y los *_layout.json de cobertura-zigbee. NO editar a mano: se rellena lat/lon EN LA CARTERA y se regenera.",
   "_fuentes": {
